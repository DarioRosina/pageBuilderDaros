...
- Added a dark mode theme with a navbar toggle and persisted user preference.

### Changed

- Refined the Page Builder visual design with updated colors, typography, spacing, shadows, modal styling, and improved light/dark theme contrast.
